...
union YYSTYPE
{
#line 16 "zoomjoystrong.y" /* yacc.c:355  */
...
static const char *const yytname[] =
{
  ...
  "circle", "rectangle", "set_color", YY_NULLPTR
};
#endif
...
{
       5,    -3,    -2,     0,     1,     9,    15,     2,    13,    -1,
      -3,    -3,    -3,    -3,    -3,    17,    18,    19,    20,    21,
      -3,    22,    -3,    23,    24,    25,    28,    29,    -3,    -3,
      30,    27,    32,    31,    33,    -3,    34,    -3,    -3,    -3
};
...
{
       1,    15,    20,    16,    17,    -3,     1,     2,     3,     4,
       5,     6,    18,     2,     3,     4,     5,     6,    19,    21,
      23,    24,    25,    26,    27,    22,     0,    30,    31,    28,
      29,    32,    33,    34,    35,    36,     0,     0,    37,     0,
      38,    39
};

static const yytype_int8 yycheck[] =
{
       1,     3,     0,     3,     3,     6,     1,     8,     9,    10,
      11,    12,     3,     8,     9,    10,    11,    12,     3,     6,
       3,     3,     3,     3,     3,     9,    -1,     3,     3,     7,
       7,     3,     3,     3,     7,     3,    -1,    -1,     7,    -1,
       7,     7
};
...
static const yytype_uint8 yystos[] =
{
      ...
      17,    18,    19,    20,    21,     3,     3,     3,     3,     3,
       0,     6,    15,     3,     3,     3,     3,     3,     7,     7,
       3,     3,     3,     3,     3,     7,     3,     7,     7,     7
};
...
#line 52 "zoomjoystrong.y" /* yacc.c:1646  */
    { if (checkConstraints((yyvsp[-2].iVal), (yyvsp[-1].iVal)) == 0) { point((yyvsp[-2].iVal), (yyvsp[-1].iVal)); } }
#line 1250 "zoomjoystrong.tab.c" /* yacc.c:1646  */
    break;

  case 12:
#line 61 "zoomjoystrong.y" /* yacc.c:1646  */
    { if (checkConstraints((yyvsp[-4].iVal), (yyvsp[-3].iVal)) == 0 && checkConstraints((yyvsp[-2].iVal), (yyvsp[-1].iVal)) == 0) { line((yyvsp[-4].iVal), (yyvsp[-3].iVal), (yyvsp[-2].iVal), (yyvsp[-1].iVal)); } }
#line 1256 "zoomjoystrong.tab.c" /* yacc.c:1646  */
    break;

  case 13:
#line 69 "zoomjoystrong.y" /* yacc.c:1646  */
    { if (checkCircleConstraints((yyvsp[-3].iVal), (yyvsp[-2].iVal), (yyvsp[-1].iVal)) == 0) { circle((yyvsp[-3].iVal), (yyvsp[-2].iVal), (yyvsp[-1].iVal)); } }
#line 1262 "zoomjoystrong.tab.c" /* yacc.c:1646  */
    break;

  case 14:
#line 78 "zoomjoystrong.y" /* yacc.c:1646  */
    { if (checkRecConstraints((yyvsp[-4].iVal), (yyvsp[-3].iVal), (yyvsp[-2].iVal), (yyvsp[-1].iVal)) == 0) { rectangle((yyvsp[-4].iVal), (yyvsp[-3].iVal), (yyvsp[-2].iVal), (yyvsp[-1].iVal)); } }
#line 1268 "zoomjoystrong.tab.c" /* yacc.c:1646  */
    break;

  case 15:
#line 86 "zoomjoystrong.y" /* yacc.c:1646  */
    { if (checkRGBConstraints((yyvsp[-3].iVal), (yyvsp[-2].iVal), (yyvsp[-1].iVal)) == 0) { set_color((yyvsp[-3].iVal), (yyvsp[-2].iVal), (yyvsp[-1].iVal)); } }
