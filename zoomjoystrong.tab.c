...
static const char *const yytname[] =
{
  ...
  "ERR", "$accept", "program", "statement_list", "statement", "point",
  "line", "circle", "rectangle", "set_color", "err", YY_NULLPTR
};
#endif
...
{
      -8,     3,     4,     5,     6,     7,    -9,    11,     8,    -8,
      -9,    -9,    -9,    -9,    -9,    -9,     9,    10,    12,    13,
      14,    -9,    15,    -9,    16,    17,    18,    21,    22,    -9,
      -9,    23,    20,    25,    24,    26,    -9,    27,    -9,    -9,
      -9
};
...
static const yytype_uint8 yytable[] =
{
      ...
      20,    21,    24,    25,    22,    26,    27,    28,     0,     0,
      31,    32,    29,    30,    33,    34,    35,    36,    37,     0,
       0,    38,     0,    39,    40,     0,     0,    23
};

static const yytype_int8 yycheck[] =
{
       8,     9,    10,    11,    12,    13,     3,     3,     3,     3,
       3,     0,     3,     3,     6,     3,     3,     3,    -1,    -1,
       3,     3,     7,     7,     3,     3,     3,     7,     3,    -1,
      -1,     7,    -1,     7,     7,    -1,    -1,     9
};
...
static const yytype_uint8 yystos[] =
{
      ...
      18,    19,    20,    21,    22,    23,     3,     3,     3,     3,
       3,     0,     6,    16,     3,     3,     3,     3,     3,     7,
       7,     3,     3,     3,     3,     3,     7,     3,     7,     7,
       7
};
...
#line 50 "zoomjoystrong.y" /* yacc.c:1646  */
    { checkConstraints((yyvsp[-2].iVal), (yyvsp[-1].iVal)); point((yyvsp[-2].iVal), (yyvsp[-1].iVal)); }
#line 1245 "zoomjoystrong.tab.c" /* yacc.c:1646  */
    break;

  case 12:
#line 59 "zoomjoystrong.y" /* yacc.c:1646  */
    { checkConstraints((yyvsp[-4].iVal), (yyvsp[-3].iVal)); checkConstraints((yyvsp[-2].iVal), (yyvsp[-1].iVal)); line((yyvsp[-4].iVal), (yyvsp[-3].iVal), (yyvsp[-2].iVal), (yyvsp[-1].iVal)); }
#line 1251 "zoomjoystrong.tab.c" /* yacc.c:1646  */
    break;

  case 13:
#line 67 "zoomjoystrong.y" /* yacc.c:1646  */
    { checkCircleConstraints((yyvsp[-3].iVal), (yyvsp[-2].iVal), (yyvsp[-1].iVal)); circle((yyvsp[-3].iVal), (yyvsp[-2].iVal), (yyvsp[-1].iVal)); }
#line 1257 "zoomjoystrong.tab.c" /* yacc.c:1646  */
    break;

  case 14:
#line 76 "zoomjoystrong.y" /* yacc.c:1646  */
    { checkRecConstraints((yyvsp[-4].iVal), (yyvsp[-3].iVal), (yyvsp[-2].iVal), (yyvsp[-1].iVal)); rectangle((yyvsp[-4].iVal), (yyvsp[-3].iVal), (yyvsp[-2].iVal), (yyvsp[-1].iVal)); }
#line 1263 "zoomjoystrong.tab.c" /* yacc.c:1646  */
    break;

  case 15:
#line 84 "zoomjoystrong.y" /* yacc.c:1646  */
    { checkRGBConstraints((yyvsp[-3].iVal), (yyvsp[-2].iVal), (yyvsp[-1].iVal)); set_color((yyvsp[-3].iVal), (yyvsp[-2].iVal), (yyvsp[-1].iVal)); }
...
#line 89 "zoomjoystrong.y" /* yacc.c:1906  */
